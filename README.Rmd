...
You can get endpoint data for multiple projects. The results will be in a single tibble:
...
If you want multiple endpoints for multiple projects, the results will be a list of tibbles:
