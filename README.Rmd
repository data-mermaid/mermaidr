...
To access fish belt data for a project, use `mermaid_get_project_data()` with `method = "beltfishes"`. 
...
Accessing Benthic PIT data works the exact same way as Fish Belt data, except you change `method` to "benthicpits":
