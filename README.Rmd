...
an open-source data platform developed to help you collect, analyze, and share coral reef monitoring data. Through `mermaidr` you can access data from collection portal, [MERMAID Collect](https://collect.datamermaid.org/), directly from R.
...
If you are new to the R programming language, our [new R users guide](articles/articles/new_to_r.html) is a great place to start!
