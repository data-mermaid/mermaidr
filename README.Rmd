...
You can access data collected on fishbelt, benthic LIT, benthic PIT, macroinvertebrates, bleaching, or habitat complexity - the main function to pull data related to your project is `mermaid_get_project_data()`:
