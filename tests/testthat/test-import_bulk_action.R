...
# duplicate SU checking is making this test difficult, need to rethink it with more energy
...
#   # TODO -- this is not true, because it is now flagged as a duplicate SU
