...
If you're running into problems using `mermaidr`, please open an issue on the [package's GitHub repository](https://data-mermaid.github.io/mermaidr/), which is where the package code lives.
