...
``` r
surveys <- mermaid_get_my_projects()
```
...
Before running the code above, make sure that you change the project name **"MERMAID Reef Survey
"** to **_your actual project_** that you want to import your data into.
...
```
## # A tibble: 0 × 22
## # ℹ 22 variables: Site * <chr>, Management * <chr>, Sample date: Year * <chr>,
...
## #   Tide <chr>, Sample unit notes <chr>, Observer emails * <chr>, Fish name * <chr>,
## #   …
```
...
##  1   1208     5               5     5               1 Parupeneus mu…      15         5
##  2   1208     5               5    20               1 Acanthurus ba…      37         1
##  3   1208     5               5    20               1 Platax teira        37         1
##  4   1208     5               5    20               1 Bolbometopon …     120         1
##  5   1208     5               5    20               1 Parupeneus in…      36         1
##  6   1208     5               5     5               1 Acanthurus au…      17         4
##  7   1208     5               5    20               1 Plectorhinchu…      36         4
##  8   1208     5               5     5               1 Zanclus cornu…      10         2
##  9   1208     5               5    20               1 Variola albim…      36         1
...
##  5 4m                                           
##  6 5m                                           
##  7 mixed: < 10cm @ 2m, >= 10cm @ 5m             
##  8 mixed: >=10 cm & <35 cm @ 5 m, >=35 cm @ 20 m
##  9 mixed: < 20cm @ 2m, >= 20cm @ 4m             
## 10 mixed: < 20cm @ 4m, >= 20cm @ 8m
```
...
## #   `Transect number *` <dbl>, `Transect length surveyed *` <dbl>, `Width *` <chr>,
## #   `Fish size bin *` <dbl>, `Reef slope` <chr>, Visibility <chr>, Current <chr>,
## #   `Observer emails *` <chr>, `Fish name *` <chr>, `Size *` <dbl>, `Count *` <dbl>
```
...
##   data_value                                    closest_choice                   match
##   <chr>                                         <chr>                            <lgl>
## 1 Mixed: >=10 cm & <35 cm @ 5 m, >=35 cm @ 20 m mixed: >=10 cm & <35 cm @ 5 m, … TRUE
```
...
There are issues in the Fish name that need to be fixed, marked by the `FALSE` note under the match column. MERMAID also provides the closest choice to help us with data cleaning. We need to fix these issues to be able to import our data:
