...
```
## • Some errors in values of `Width *` - please check table below
```
...
##   data_value                                   closest_choice            match
##   <chr>                                        <chr>                     <lgl>
## 1 Mixed: >10 cm & <35 cm @ 5 m, >=35 cm @ 20 m Mixed: >=10 cm & <35 cm … FALSE
```
...
```
## • Some errors in values of `Current` - please check table below
```
...
```
## Warning: Failed to import data. Problems:
```

```
## # A tibble: 10 × 3
##    row_number data__fishbelt_transect__width            data__fishbelt_trans…¹
##         <dbl> <chr>                                     <chr>                 
##  1          1 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  2          2 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  3          3 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  4          4 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  5          5 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  6          6 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  7          7 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  8          8 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
##  9          9 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
## 10         10 "\"mixed: >10 cm & <35 cm @ 5 m, >=35 cm… "\"low\" is not a val…
## # ℹ abbreviated name: ¹​data__fishbelt_transect__current
```
