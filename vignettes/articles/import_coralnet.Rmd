...
pqt <- raw
pqt <- pqt %>%
  mutate(`Transect number *` = str_remove(Transect, "T"))
```
...
![Calculate number of points for each benthic attribute from the same quadrat.](images/import-coralnet/CoralNet_Summarizing_points.png)
