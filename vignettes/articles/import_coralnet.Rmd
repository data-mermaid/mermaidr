...
1.  Get your MERMAID project using the `mermaid_get_my_projects()` function.
...
Before running the code above, make sure that you change the project name "**MERMAID Reef Surveys (training only)"** to [**your actual project**]{.underline} that you want to import your data into.
