...
![CoralNet export data with auxiliary fields.](../../inst/extdata/import-coralnet-vignette/CoralNet_export.png){fig-alt="A screenshot of a spreadsheet file exported from CoralNet that includes the auxiliary fields."}
...
![Example of the benthic attribute converter file.](../../inst/extdata/import-coralnet-vignette/CoralNet_BA_converter_file.png){fig-alt="A screenshot of a spreadsheet CSV file that consist of four columns, which are Benthic_abb, Benthic category, Benthic attribute_MERMAID, and Growth form_MERMAID."}
