...
![CoralNet export data with auxiliary fields.](images/import-coralnet/CoralNet_export.png){fig-alt="A screenshot of a spreadsheet file exported from CoralNet that includes the auxiliary fields."}
...
![Example of the benthic attribute converter file.](images/import-coralnet/CoralNet_BA_converter_file.png){fig-alt="A screenshot of a spreadsheet CSV file that consist of four columns, which are Benthic_abb, Benthic category, Benthic attribute_MERMAID, and Growth form_MERMAID."}
...
![Calculate number of points for each benthic attribute from the same quadrat.](../../inst/extdata/import-coralnet-vignette/CoralNet_Summarizing_points.png)
...
## [11] "Number of quadrats *"           "Quadrat size *"                
## [13] "First quadrat number"           "Number of points per quadrat *"
## [15] "Reef slope"                     "Visibility"                    
## [17] "Current"                        "Relative depth"                
## [19] "Tide"                           "Sample unit notes"             
## [21] "Observer emails *"              "Quadrat *"                     
## [23] "Benthic attribute *"            "Growth form"                   
## [25] "Number of points *"
```
...
```
## ✔ Any value is allowed for `Number of points per quadrat *` - no checking to be
## done
```
