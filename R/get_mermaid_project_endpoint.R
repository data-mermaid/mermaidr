...
mermaid_project_endpoint_columns <- list(
  ...
  benthicpittransectmethods = c("id", "transect", "interval_size", "sample_event", "benthic_transect", "observers", "obs_benthic_puts", "created_on", "updated_on"),
  ...
  obsbenthicpits = c("id", "data", "interval", "incude", "notes", "benthicpit", "attribute", "growthform", "created_on", "updated_on"),
