...
#' }
mermaid_search_projects <- function(name = NULL, countries = NULL, tags = NULL, include_test_projects = FALSE, limit = NULL, as_is = FALSE) {
  mermaid_search_my_projects(name, countries, tags, include_test_projects, limit, token = NULL, as_is = as_is)
}
